...
return (  `transparent linear-gradient(90deg, ${notesColors[index]} 0%, #FFFFFF00 100%) `)
    ...
    const notesOnClick = (value, index) => {
        ...
        // dispatch({ type: "EDIT_CONTACT_NOTES", payload: newNotes });
    ...
    const addNote = () => {
        // dispatch({ type: "SET_NOTES", payload: [...state.notes, ""] });
    ...
    const notesOnClick1 = (value, index) => {
        ...
        //             console.log(slides, "2222222222222---------------------");
        //             setSlides([...slides,
        //             <img src="https://picsum.photos/800/301/?random" alt="2" />,]
        //             )
        //         })
    ...
    // const color = ["#87D6F2", "#DE468C", "#8E47FD", "#F0DB31", "#99E819"]
    // const headerColor = ["#5EC1E3", "#C3A84D"]
    // useEffect(() => {
    //     if (state.notes)
    //         state.notes.map((note, index) => {
    //             slides.push(
    //                 <Note index={index} notesOnClick={notesOnClick} addNote={addNote} removeNote={removeNote}
    //                     noteIndex={noteIndex} setNoteIndex={setNoteIndex} noteValue={noteValue} setNoteValue={setNoteValue} />
    //             )
    //         })
    ...
    return (
        <div className="noteMain">
            ...
            <div className="d-flex notesDiv">
                ...
                <div onClick={() => move("left")} >{<ChevronLeftIcon style={{ color: '#555555' }} />}</div>     
                   ...
                   <div className={`noteWrap15  ${isMove?" from1-2":""}`} onClick={() => { arrowNote("right", 2); }}>
                    ...
                    {/* <div className="openNote" hidden={!showNote}>{noteValue}</div> */}
            ...
            {/* {aa && <Carousel slides={slides} autoplay={true} />} */}
            {/* <Button variant="outlined" onClick={() => notesOnClick1()} >Not33es</Button> */}
